...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        Piece foundedPiece = makeMove(source, target);
        if (testCheck(currentPlayer)) {
            undoMove(source, target, foundedPiece);
        ...
        return (ChessPiece) foundedPiece;
    }
    ...
    public ChessPiece replacePromotedPiece(String type){
        if(promoted == null){
            throw new IllegalStateException("There is no place to promoted");
    ...
    private void nextTurn() {
        ...
        //Estrtura Operador Ternário:
        // 1°: Condicional (SE) current player --> Color.WHITE
        //2°: (ENTÃO) --> currentPlayer = Color.BLACK
        //3°: (SENÃO) --> currentPlayer = Color.WHITE
    ...
    private Piece makeMove(Position source, Position target) {
        ...
        if(p instanceof  Pawn){
            if(source.getColum() != target.getColum() && t == null){
                ...
                t = board.removePiece(pawnPosition);
                capturedPieces.add(t);
                piecesOnTheBoard.remove(t);
